...
- Job analysis through `/api/jobs/analyze` using a public job posting URL.
...
sample resume, analyzes the sample job, verifies the job URL request contract,
checks workflow trace timing and Markdown/DOCX/LaTeX/PDF exports, and captures
desktop/mobile screenshots under `Frontend/.local/playwright-results`.
